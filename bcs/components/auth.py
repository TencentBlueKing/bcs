...
ACCESS_TOKEN_PATH = sdk.get_sensitive_conf("ACCESS_TOKEN_PATH")
...
def get_access_token():
    ...
    if ACCESS_TOKEN_PATH:
        url = "{}/{}".format(IAM_HOST, ACCESS_TOKEN_PATH.lstrip("/"))
    else:
        url = "{}/api/v1/auth/access-tokens".format(IAM_HOST)
    data = {'grant_type': 'client_credentials', 'id_provider': 'client'}
    headers = {"X-BK-APP-CODE": APP_CODE, "X-BK-APP-SECRET": APP_SECRET}
